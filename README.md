...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 4 · Changelog: fresh (0 d)
...
| Pkg folder | [packages\email-verifications](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\email-verifications) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package email-verifications -Apply
