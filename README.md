...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 4 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\email-verifications](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\email-verifications)
...
graph LR
  ...
  email_verifications["email_verifications"]:::center
  email_verifications -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package email-verifications -Apply
