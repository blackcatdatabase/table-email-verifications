...
final class EmailVerificationsModule implements ModuleInterface
{
    public function name(): string { return 'table-email_verifications'; }
    public function table(): string { return 'email_verifications'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_ev_expires', 'idx_ev_user', 'ux_ev_selector' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_ev_expires', 'idx_ev_user', 'ux_ev_selector' ],
