...
final class EmailVerificationRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`email_verifications`' : '"email_verifications"';
     ...
     * [ 'selector' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'user_id', 'token_hash', 'validator_hash', 'key_version', 'expires_at', 'created_at', 'used_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'selector' ];
        $upd  = [ 'user_id', 'token_hash', 'validator_hash', 'key_version', 'expires_at', 'created_at', 'used_at' ];
