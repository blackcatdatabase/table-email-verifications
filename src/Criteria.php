...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'token_hash', 'selector', 'validator_hash', 'key_version', 'expires_at', 'created_at', 'used_at' ];
    }
    ...
    {
        $x = [ 'id', 'user_id', 'token_hash', 'selector', 'key_version', 'expires_at', 'created_at', 'used_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EmailVerifications\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EmailVerifications\Definitions::softDeleteColumn();
