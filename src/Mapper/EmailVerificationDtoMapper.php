...
namespace BlackCat\Database\Packages\EmailVerifications\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO EmailVerificationDto:
...
final class EmailVerificationDtoMapper
{
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'validator_hash' ];
     ...
     */
    public static function fromRow(array $row): EmailVerificationDto
    {
        /** @var EmailVerificationDto */
    ...
    public static function fromRowOrNull(?array $row): ?EmailVerificationDto
    {
     ...
     *
     * @param EmailVerificationDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EmailVerificationDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EmailVerificationDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EmailVerificationDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EmailVerificationDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EmailVerificationDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EmailVerificationDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EmailVerificationDto>
     */
