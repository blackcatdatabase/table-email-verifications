...
use BlackCat\Database\Packages\EmailVerifications\Repository\EmailVerificationRepository as GeneratedRepository;
...
{
  private EmailVerificationRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EmailVerificationRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EmailVerificationRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EmailVerifications\Dto\EmailVerificationDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EmailVerifications\Dto\EmailVerificationDto|null { return $this->repo->getById($id, $asDto); }
